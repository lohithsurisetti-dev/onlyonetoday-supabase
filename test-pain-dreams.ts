...
// Find shared symbols
function findSharedSymbols(symbols1: string[], symbols2: string[]): string[] {
...
function findSharedEmotions(emotions1: string[], emotions2: string[]): string[] {
...
function findSharedKeywords(content1: string, content2: string): string[] {
